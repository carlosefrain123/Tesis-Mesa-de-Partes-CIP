...
<head>
    ...
    <meta charset="utf-8">
    <title>Recuperar Contraseña || Colegio de Ingenieros</title>
...
<body>
                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    <div class="alert alert-success text-center mb-4 mt-4 pt-2" role="alert">
                                        Ingrese su correo eléctrónico, y siga las instrucciones
                                    </div>
                                    ...
                                    <div class="mt-5 text-center">
                                        <p class="text-muted mb-0">Regresa a<a href="../../view/accesopersonal/index.php" class="text-primary fw-semibold"> acceder </a> </p>
                                    </div>
                                </div>
    ...
    <script src="recuperarcolaborador.js"></script>
</body>
