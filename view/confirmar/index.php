...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>Confirmar | Colegio de Ingenieros</title>
                                    ...
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            ...
                                            <div class="p-2 mt-4">
                                                ...
                                                <p class="text-muted">Su cuenta a sido validada, ya se puede regresar a la pantalla ´principal y acceder al sistema de Mesa de Partes.</p>
                                                <div class="mt-4">
